...
public class AVLTree<E extends Comparable<E>> extends BinarySearchTreeWithRotate<E> {
	 ...
	 * 
	 * @pre The balance field was correct prior to an insertion [or removal,]
	 *      and an item is either been added to the left[ or removed from the
	 *      right].
	 * @post The balance is decremented and the increase flags is set to false
	 *       if the overall height of this subtree has not changed.
	 * @param node
	 *            The AVL node whose balance is to be decremented
	 */
	 ...
	 *       if the overall height of this subtree has not changed.
	 * @param node
	 *            The AVL node whose balance is to be incremented
	 */
